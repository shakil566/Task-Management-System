...
CREATE DATABASE IF NOT EXISTS `task_management_system` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `task_management_system`;

-- Dumping structure for table task_management_system.assign_task
...
CREATE TABLE IF NOT EXISTS `assign_task` (
  ...
  `status` enum('1','2','3') NOT NULL DEFAULT '1' COMMENT '1 = Pending, 2 = Working, 3 = Done',
...
-- Dumping structure for table task_management_system.password_resets
...
-- Dumping structure for table task_management_system.personal_access_tokens
...
-- Dumping structure for table task_management_system.projects
...
CREATE TABLE IF NOT EXISTS `users` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_group_id` bigint(20) unsigned NOT NULL DEFAULT 1,
  `name` varchar(255) NOT NULL,
...
-- Dumping structure for table task_management_system.user_group
