                ...
                <div class="col-md-8 margin-top-10">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('english.UPDATE_PROJECT')</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        {{ Form::model($project, array('route' => array('project.update', $project->id), 'method' => 'PATCH', 'class' => 'form-horizontal', 'id' => 'projectEditForm')) }}
